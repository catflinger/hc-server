...
import { IControlState } from "../../common/interfaces";
...
export class System implements ISystem {
    ...
    constructor(
        ...
        @inject(INJECTABLES.Device) private device: DeviceConstructor) {
            this.boiler = new device("boiler", "boiler", path.join(this.gpioRoot, "gpio16", "value"));
            this.hwPump = new device("hwPump", "hot water pump", path.join(this.gpioRoot, "gpio20", "value"));
            this.chPump = new device("chPump", "central heating pump", path.join(this.gpioRoot, "gpio21", "value"));
    }
